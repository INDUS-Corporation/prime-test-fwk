 ...
 * 
 */
package com.induscorp.prime.testing.ui.core.interfaces;
...
public interface LogonLocator {
	public UIObject getLoginDialogLocator();

	public UIObject getUserNameLocator();

	public UIObject getPasswordLocator();
