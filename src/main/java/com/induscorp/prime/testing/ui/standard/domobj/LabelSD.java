...
public class LabelSD extends Label {
	...
	public LabelSD(String displayName, String xpath) {
		super(LocatorType.DOM, displayName);
		this.xpath = xpath;
	}

	@Override
	public LabelValidatorSD getValidator(WebBrowser browser, Region region) {
		return new LabelValidatorSD(browser, this, region);
	}
