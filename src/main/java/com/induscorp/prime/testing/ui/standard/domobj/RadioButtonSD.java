...
public class RadioButtonSD extends RadioButton {
	...
	@Override
	public RadioButtonValidatorSD getValidator(WebBrowser browser, Region region) {
		return new RadioButtonValidatorSD(browser, this, region);
	}
	...
	@Override
	public RadioButtonSD updateLocatorParameterWithValue(String paramName, String value) {
		String newXPath = xpath.replaceAll(":" + paramName, value);
		return new RadioButtonSD(displayName, newXPath);
	}
