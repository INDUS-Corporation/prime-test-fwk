...
public class ListBoxSD extends ListBox {
	...
	public ListBoxSD(String displayName, String xpath) {
		super(LocatorType.DOM, displayName);
		this.xpath = xpath;
	}

	@Override
	public ListBoxValidatorSD getValidator(WebBrowser browser, Region region) {
		return new ListBoxValidatorSD(browser, this, region);
	}
